...
from app.healing import HealingSaves, HealingSnipes, HealingManaConsumes, HealingTaps
...
class Main():
    ...
    def __init__(self, config_dir='stored_configs', figures_dir='stored_figures'):
        ...
        self.tap_heals = HealingTaps(self.report, self.api, fig_dir=self.figures_dir, healing_spells=self.healing_spells.content, full_report=True)
