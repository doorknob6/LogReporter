...
class Main():
    ...
    def __init__(self, config_dir='stored_configs', fig_dir='stored_figures'):
        self.app_dir = os.path.dirname(os.path.realpath(__file__))
        self.config_dir = os.path.join(self.app_dir, config_dir)
        self.fig_dir = os.path.join(self.app_dir, fig_dir)
        ...
        self.healing_saves = HealingSaves(self.report, self.api, self.fig_dir)
        self.healing_saves.healing_saves()
        self.healing_saves.make_event_plot(self.healing_saves.near_deaths)
        self.healing_saves.make_save_plot(self.healing_saves.save_healers)
